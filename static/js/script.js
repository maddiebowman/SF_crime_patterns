document.addEventListener('DOMContentLoaded', function () {
    const incidentUrl = "http://127.0.0.1:5000/aggregated_data";
    ...
    fetch(incidentUrl)
        ...
        .then(data => {
            ...
            // Adding x-axis label at the very end of the right side
            svg.append("text")
                .attr("x", width - margin.right - 10)  // Adjust position to avoid overlap with progress bar
            ...
            // Adding y-axis label horizontally at the top
            svg.append("text")
                .attr("x", -margin.left + 20)  // Adjust position to avoid overlap
